...
load_dotenv(".env")
bot = interactions.Client(token=os.getenv("TOKEN"), intents=intents)
...
@bot.command(
  ...
  options=[
    ...
    interactions.Option(
      ...
      #value="choice_one",
      choices=[
        interactions.Choice(name="Dungeon Kurashi No Moto Yuusha",
                            value="Dungeon Kurashi No Moto Yuusha"),
        ...
        interactions.Choice(
          name="Kamigami ni Sodaterare Shimo no, Saikyou to Naru",
          value="Kamigami ni Sodaterare Shimo no, Saikyou to Naru"),
        interactions.Choice(name="Shindou Yuusha to Maid Onee-san",
                            value="Shindou Yuusha to Maid Onee-san"),
        interactions.Choice(
          name="Hyakuren no Haou to Seiyaku no Ikusa Otome",
          value="Hyakuren no Haou to Seiyaku no Ikusa Otome"),
        ...
        interactions.Choice(name="Return of the Invincible Patriarch",
                            value="Return of the Invincible Patriarch"),
        interactions.Choice(name="High School Taoist",
                            value="High School Taoist"),
        interactions.Choice(name="Teenage Swordsman",
                            value="Teenage Swordsman"),
        interactions.Choice(name="Magician from Another World",
                            value="Magician from Another World"),
        interactions.Choice(name="Maou desu.", value="Maou desu."),
        interactions.Choice(name="I Have Twin Girfriends",
                            value="I Have Twin Girfriends"),
        interactions.Choice(name="Maou Gakuen no Hangyakusha",
                            value="Maou Gakuen no Hangyakusha"),
        interactions.Choice(name="Isekai Monster Breeder",
                            value="Isekai Monster Breeder"),
      ],
      #autocomplete=True,
    ),
    interactions.Option(
...
async def tache_fini(ctx: interactions.CommandContext,
                     ...
                     fichier=None):
  print(
    f"<@{ping.id}>\t> <@{ctx.author.id}> a terminer de **{poste}**\t> Le chapitre **{chapitre}** de **{projet}**"
  )
